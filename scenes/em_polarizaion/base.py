...
class CircularPolarization(ThreeDScene):
    ...
    def construct(self):
        ...
        x_label = axes.get_y_axis_label(MathTex(r'\hat x').scale(3))
        y_label = axes.get_z_axis_label(MathTex(r'\hat y').scale(3))
        z_label = axes.get_x_axis_label(MathTex(r'\hat z').scale(3))
